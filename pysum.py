...
def summarize(document):
	...
	auto_abstractor.tokenizable_doc = MeCabTokenizer().set_mecab_system_dic("-r /etc/mecabrc")
	...
	nlp_base.tokenizable_doc = MeCabTokenizer().set_mecab_system_dic("-r /etc/mecabrc")
